...
export default {
  ...
  mounted() {
    axios
      .get(`/api/communities/${this.$route.params.slug}`, {
        headers: {
      ...
      .then((res) => {
        ...
        this.content_types = res.data.content_types;
  ...
  methods: {
    ...
    submitForm() {
      axios
        .put(
          `/api/communities/${this.$route.params.slug}`,
          {
            name: this.name,
        ...
        .then((response) => {
          if (response.status === 200) {
            swal({
              ...
              if (click) {
                this.$router.push(
                  `/communities/${response.data.community.slug}`
                );
              }
            });
          }
