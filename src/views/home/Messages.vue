<template>
  <div class="messages">
    <div class="chat-container">
      ...
      <div class="conversation-list" v-show="!friendsListOpen">
        <div
          class="conversation"
      ...
      <div class="friends-list" v-show="friendsListOpen">
        <div
          class="friends"
      ...
      <div class="new-message-container">
        <i
          v-bind:class="[friendsListOpen ? 'fas fa-users' : 'fas fa-comments']"
          @click="changeIcon()"
        ></i>
      </div>
...
export default {
      ...
      friends: [
        {
          ...
          image:
            'https://img.freepik.com/free-photo/photo-charismatic-lovely-woman-with-curly-hair-has-fun-toothy-smile-face_273609-30436.jpg?size=626&ext=jpg&ga=GA1.2.2102900112.1628985600',
        },
        {
          id: 2,
          name: 'Andrew Reichert',
          image:
            'https://images.squarespace-cdn.com/content/v1/5a8a9449f43b552a84c6cca4/1530763131943-9I0QL1BNKZVLPE963USQ/deaf+man.jpg?format=1000w',
        },
        {
          id: 3,
        ...
        },
        {
          ...
          name: 'Chelsey ',
          image:
            'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MXwxMTI4NzN8MHwxfGNvbGxlY3Rpb258MjE0fDQ3NDIwNXx8fHx8Mnw&ixlib=rb-1.2.1&q=80&w=400',
        },
      ],
      conversations: [
        {
        ...
        },
        {
          ...
          image:
            'https://img3.goodfon.com/wallpaper/nbig/c/ad/nikolas-holt-nicholas-hoult-5153.jpg',
          created: '17 Aug',
          text: 'thank you',
        },
        {
          ...
          image:
            'https://images.squarespace-cdn.com/content/v1/5421eeb5e4b0517ce1c883f2/1572017189259-6D5O6ZHAP4KVB9PYAKNJ/glenna.jpg?format=1000w',
          created: '15 Aug',
          text: 'see you again',
        },
        {
          ...
          image:
            'https://thegritandgraceproject.org/wp-content/uploads/2019/04/How-to-Become-the-Woman-You-Want-to-Be-1300x866.jpg',
          created: '15 Aug',
          text: '.',
        },
      ],
  ...
  methods: {
    changeIcon() {
      if (!this.friendsListOpen) this.friendsListOpen = true;
      else this.friendsListOpen = false;
    },
    sendMessage() {
      if (this.send !== '') {
        const date = new Date();
    ...
    filterConversations: {
      get() {
        return this.conversations.filter(
          (conversation) => conversation.name.toLowerCase().includes(this.search.toLowerCase()),
        );
      },
      set() {},
    },
    filterFriends: {
      get() {
        return this.friends.filter(
          (friend) => friend.name.toLowerCase().includes(this.search.toLowerCase()),
        );
      },
      set() {},
    },
