<template>
  ...
  <div class="row">
    ...
    <div
      class="info-3"
    >
      <h6 style="text-align: left">COMMUNITY REVIEWS</h6>
      <hr style="width:64%;"/>
    </div>
  </div>
</template>
  ...
  data() {
    return {
      ...
      content: {
        ...
        image:
          'https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1580788273l/52845775._SX318_SY475_.jpg', // image url
        rate: '6.5/10',
        description:
